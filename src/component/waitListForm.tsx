...
const WaitListForm = ({ isOpen, setIsOpen }: Props) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/90  flex items-center justify-center z-50 modal-overlay transition-opacity duration-300">
      <div className="bg-[#1F2937] rounded-lg shadow-xl max-w-md w-full mx-4 overflow-hidden transform transition-all duration-300">
        {/* Modal Header */}
